...
pictures = ['estetic.png', 'puzzle_1.png', 'puzzle_2.jpg', 'puzzle_3.jpg', 'puzzle_4.jpg']

class Add():
    def got(self, image):
        self.choosen = image
        pictures.append(self.choosen)
    def start(self):
        pygame.init()
        ...
        def start_game(mode):
            ...
            cell_width = WINDOW_WIDTH // rows  # кол-во столбцов и строк
            ...
            for i in range(num_cells):
                ...
                cells.append({'rect': rect, 'border': WHITE, 'order': i, 'pos': rand_pos})  # создаётся кусок с изначальным местоположением, и его будущее место
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1 and not game_over:
                    ...
                    for cell in cells:
                        ...
                        if rect.collidepoint(mouse_pos):  # выделяем красным цветом выбранный кусок
                            if not selected_img:
                                selected_img = cell
                                cell['border'] = RED
                            else:
                                ...
                                if current_img['order'] != selected_img['order']:  # перемешаем кусочки
                                    ...
                                    game_over = True  # собран ли паззл
                                    for cell in cells:
